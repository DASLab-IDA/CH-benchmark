...
class Transactions{
	...
	private:
		...
		bool prepareNewOrder(SQLHDBC& hDBC);
		bool preparePayment(SQLHDBC& hDBC);
		bool prepareOrderStatus(SQLHDBC& hDBC);
		bool prepareDelivery(SQLHDBC& hDBC);
		bool prepareStockLevel(SQLHDBC& hDBC);
